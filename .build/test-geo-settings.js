...
//  somebody else's whole policy. The three things that would do real damage if
...
const { GeoExt, POLICY_KEYS, EXT_SETTINGS, regValue } = require('../lib/geo-ext');
...
(async () => {
    ...
    console.log('── a clean machine: the entry is written everywhere ──');
